...
const integrations: Integration[] = [
  {
    ...
    short: "M",
    category: "Email",
    description: "Automatically find invoice attachments and send approved customer follow-ups.",
    color: "bg-white",
  ...
  },
  {
    ...
    short: "Z",
    category: "Accounting",
    description: "Push verified invoices, customers, tax codes, and payment status into Zoho Books.",
    color: "bg-gradient-to-br from-[#ef4444] via-[#facc15] to-[#3b82f6]",
    textColor: "text-white",
    features: ["Two-way sync", "Customer matching"],
  },
  {
    id: "quickbooks",
    name: "QuickBooks",
